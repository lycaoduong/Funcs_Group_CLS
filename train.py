...
def get_args():
    ...
    parser.add_argument('-lr', '--lr', type=float, default=2e-5, help='Init Learning Rate')
    parser.add_argument('-ep', '--epochs', type=int, default=1240, help='Init number of train epochs')
