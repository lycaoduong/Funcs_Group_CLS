...
def get_args():
    ...
    parser.add_argument('-m', '--model', type=str, default='Fcg-test', help='Choosing Model')
    ...
    parser.add_argument('-op', '--input', type=str, default='./100005.npy', help='Choosing optimizer')
